...
A typical MEMS IMU consists of 2 separate sensors. A rate gyroscope, measuring angular velocity along 3 sensor frame axis, in $rad/s$. As well as a 3-axis accelerometer, measuring linear acceleration along the same three axis, in $m/s^2$.
...
Measurement model for accelerometer observations $a_y$ can be represented as:
